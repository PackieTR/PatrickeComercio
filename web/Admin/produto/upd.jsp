                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <img class="img-thumbnail center-block" <%if (x.getImagem1() != null) {%>src="../../img/<%=x.getImagem1()%><%}%>"/>
                        ...
                        <div class="row">
                            ...
                            <img class="img-thumbnail center-block" <%if (x.getImagem2() != null) {%>src="../../img/<%=x.getImagem2()%><%}%>"/>
                        ...
                        <div class="row">
                            ...
                            <img class="img-thumbnail center-block"  <%if (x.getImagem2() != null) {%>src="../../img/<%=x.getImagem3()%><%}%>"/>
